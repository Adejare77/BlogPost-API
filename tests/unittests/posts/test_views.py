from rest_framework.test import (
    APITestCase, force_authenticate, APIRequestFactory
    )
...
class PostListViewTests(APITestCase):
    ...
    def test_create_post_without_authentication(self):
        ...
        self.assertEqual('Authentication credentials were not provided', str(response.data.get('detail')))
